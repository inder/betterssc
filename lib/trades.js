...
const VERB_RE = new RegExp(
  [
    // BUY
    "(?<buy>\\b(?:bought|buying|added|adding|entered|entering|picked up|grabbed|scaled into|starter)\\b)",
    // SELL — closed (whole position gone)
    "(?<closed>\\b(?:closed out|closed|closing|exited|exiting|stopped out|covered|dumped|out of|got out of|cut)\\b)",
    // SELL — partial
    "(?<partial>\\b(?:trimmed|trimming|trim|took profits|took some profits|taking profits|lightened|scaled out)\\b)",
