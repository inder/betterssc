...
// Crypto symbols among KNOWN_TICKERS. Price lookups for these must map to
// the Yahoo "<SYM>-USD" pair (e.g. BTC → BTC-USD), not the bare symbol.
// Kept as a separate Set so the price layer (background.js) and the ticker
// extractor (lib/trending.js) can both tell "is this a coin?" without a
// duplicated hardcoded list. Every entry here is also in KNOWN_TICKERS.
