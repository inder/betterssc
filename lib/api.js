...
// broadcast posts. At 25/page against this channel's cadence the active thread
// was comfortably on page 1, so resolveChannelTarget only reads the first page
// — if that stops holding, page with `before` until a post with a non-null
// reply timestamp is found rather than widening the picker's heuristics.
