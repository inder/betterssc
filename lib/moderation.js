...
// How long a reworded message sits visibly in the composer before it
// auto-posts (slice 4) — the arc's oracle says "1-2 seconds," this is the
// middle of that range. Deliberately a FIXED constant, unrelated to
// aiModerationDebounceMs — debounce controls how long BEFORE review the
// composer waits to catch a burst; this controls how long AFTER review
// the composer waits before auto-posting the approved result. Different
// knobs for different waits.
export const MODERATION_COUNTDOWN_MS = 1500;
